...
export default function MessageInterface() {
    ...
    return (
        <div className="message-interface">
            ...
            <FineSep dashed />
            <h3>תגובות (6)  </h3>
            {comments.length === 0 ? <CircularProgress style={{ display: "flex", alignSelf: "center", alignItems: "center", justifyContent: "center" }} /> : comments.filter((comment, index) => index < 3).map((comment, index) => {
