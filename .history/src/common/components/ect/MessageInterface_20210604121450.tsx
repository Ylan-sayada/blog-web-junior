...
export default function MessageInterface() {
    ...
    return (
        <div className="message-interface">
            ...
            {comments.length === 0 ? <div style={{ display: "flex", justifyContent: "center", padding: "0 20px" }}><CircularProgress /></div> : comments.filter((comment, index) => index < 3).map((comment, index) => {
